...
import com.lamnguyen5464.avatar3dme.databinding.ActivityMainBinding
import com.lamnguyen5464.avatar3dme.obj.ObjModel
import com.lamnguyen5464.avatar3dme.ply.PlyModel
import com.lamnguyen5464.avatar3dme.stl.StlModel
import com.lamnguyen5464.avatar3dme.util.Util.closeSilently
...
class ModelActivity : AppCompatActivity() {
    ...
    private val requestPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted ->
        if (isGranted) {
            ...
            //Toast.makeText(this, 'Read permission failed', Toast.LENGTH_SHORT).show()
        }
    }
